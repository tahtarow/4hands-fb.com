...
function response() {
    ...
    $.ajax({
        url: "<?=localisation::$url_for_activation_translate_process?>",
        type: 'POST',
        dataType: 'json',
        data: {check_task: 1},
        ...
        success: function (json) {
            if (typeof (json.txt) !== "undefined") {
                if (params.get("text") !== json.txt &&
                    params.get("tl") !== json.lang) {
                    console.log(json.txt);
                    console.log(json.lang);
                    window.location.href = 'https://translate.google.com.ua/?&op=translate&sl=<?=localisation::$main_lang?>&tl=' + json.lang + '&text=' + json.txt;
                } else {
                    ...
                    $.ajax({
                        ...
                        data: {
                            result: {
                                txt: json.txt,
                                translated_txt: $('.tlid-translation span')[0].innerText,
                                lang: json.lang,
                            }
                        },
                        ...
                        complete: function () {
                            // console.log('<p>Запрос полностью завершен!</p>');
                        },
                        success: function (json) {
                            // response();
                            // if(typeof(json.txt) == "undefined"){
                            location.href = "https://translate.google.com.ua/";
                            // }
                        }
                    })
                }
